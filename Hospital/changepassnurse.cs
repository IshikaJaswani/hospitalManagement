...
namespace Hospital
{
    public partial class changepassnurse : Form
    {
        ...
        private void changepassnurse_Load(object sender, EventArgs e)
        {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            if (textBox3.Text != null)
            {
                ...
                sql = "select employeeid,ssn from nurse t where t.employeeid=" + uname + " ";
                    ...
                    while (dr.Read())
                    {
                        if (textBox3.Text == dr[0].ToString())
                        {
                            if (textBox1.Text == dr[1].ToString())
                            {
                                ...
                                sql1 = "Update nurse set ssn='" + npass + "' where employeeid=" + uname + "";
