    ...
    public partial class appointment1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                int t1 = 15;
                int t2 = 17;
                int hour = start_dt_time.Hour;
                int hours = end_dt_time.Hour;
                string physician;
                physician = textBox4.Text;
                if (hour > t1 && hours < t2)
                {
                    sql = "select start_dt_time,end_dt_time,physician from appointment where physician=" + physician + "";
                    cmd = new OleDbCommand(sql, con);
                    con.Open();
                ...
                {
                    MessageBox.Show("Doctor not available");
                }
            }
        }
